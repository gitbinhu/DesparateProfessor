...
public class VisitorCount extends HttpServlet {
	...
	out.println ("<form action=\"http://unix.seas.gwu.edu:40127/servlets/examples/VisitorCount\" method=\"post\">");

	// out.println ("<form action=\"http://localhost:40127/servlets/examples/VisitorCount\" method=\"post\">");
