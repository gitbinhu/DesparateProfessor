...
public class PageCount extends HttpServlet {
	...
	out.println ("<form action=\"http://unix.seas.gwu.edu:40127/servlets/examples/PageCount\" method=\"post\">");

	// out.println ("<form action=\"http://localhost:40127/servlets/examples/PageCount\" method=\"post\">");
